...
% Body Dimensions
P.Body.w_p = 1334.47; % N, 300LBS Maximum ladder carrying capacity
P.Body.h = 1.83; % 6ft Height
P.Body = calcBodyDims(P.Body); % Structure containing body dimensions
